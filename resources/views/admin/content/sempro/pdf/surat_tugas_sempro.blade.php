    ...
    <div class="badan">
            ...
            <table class="details-table" style="padding-left: 20px;">
                @if ($data_sidang_sempro)
                    <tr>
                        ...
                        <td class="value">: {{ $data_sidang_sempro->r_mahasiswa->nama }}</td>
                    </tr>
                    <tr>
                        <td class="label">NIM</td>
                        <td class="value">: {{ $data_sidang_sempro->r_mahasiswa->nim }}</td>
                    </tr>
                    <tr>
                        <td class="label">Program Studi</td>
                        <td class="value">: {{ $data_sidang_sempro->r_mahasiswa->r_prodi->prodi }}</td>
                    </tr>
                    <tr>
                        <td class="label">Judul</td>
                        <td class="value">: {{ $data_sidang_sempro->judul }}</td>
                    </tr>
                @endif
            </table>
        </div>
        ...
        <table class="isi">
            ...
            <tbody>
                <tr class="table-light">
                    <td class="hari">
                        {{ \Carbon\Carbon::parse($data_sidang_sempro->tgl_sempro)->locale('id')->translatedFormat('l') }}
                    </td>
                    <td class="tanggal_sidang">
                        {{ \Carbon\Carbon::parse($data_sidang_sempro->tgl_sempro)->format('d-m-Y') }}</td>
                    <td class="jam">{{ $data_sidang_sempro->r_sesi->jam }}</td>
                    <td class="ruangan">{{ $data_sidang_sempro->r_ruangan->kode_ruang }}</td>
                </tr>
            </tbody>
        </table>
        <br>
