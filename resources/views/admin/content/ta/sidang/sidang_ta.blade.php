                                ...
                                <tr class="table-light">
                                    ...
                                    <td>
                                        @if ($data->r_ketua)
                                            ...
                                            @else
                                                {{ $data->r_ketua->nama_dosen . ' - Belum Ada Nilai' }}
                                            @endif
                                        @else
                                            {{ 'Belum Ada Ketua' }}
                                        @endif
                                    ...
                                    <td>
                                        @if ($data->r_sekretaris)
                                            ...
                                            @else
                                                {{ $data->r_sekretaris->nama_dosen . ' - Belum Ada Nilai' }}
                                            @endif
                                        @else
                                            {{ 'Belum Ada Sekrearis' }}
                                        @endif
                                    ...
                                    <td>
                                        @if ($data->r_penguji_1)
                                            ...
                                            @else
                                                {{ $data->r_penguji_1->nama_dosen . ' - Belum Ada Nilai' }}
                                            @endif
                                        @else
                                            {{ 'Belum Ada Penguji 1' }}
                                        @endif
                                    ...
                                    <td>
                                        @if ($data->r_penguji_2)
                                            ...
                                            @else
                                                {{ $data->r_penguji_2->nama_dosen . ' - Belum Ada Nilai' }}
                                            @endif
                                        @else
                                            {{ 'Belum Ada Penguji 2' }}
                                        @endif
