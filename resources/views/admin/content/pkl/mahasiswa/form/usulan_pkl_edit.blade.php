        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form class="forms-sample" method="post"
                    action="{{ route('usulan_pkl.update', ['id' => $data_usulan_pkl->id_usulan_pkl]) }}"
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="id_usulan_pkl" name="id_usulan_pkl"
                            value="{{ $data_usulan_pkl->id_usulan_pkl }}" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @else
                            <div class="alert alert-danger">ID Mahasiswa tidak ditemukan. Pastikan akun Anda terhubung
                                dengan data Mahasiswa.</div>
                        @endif
                        @error('mahasiswa_id')
                            <small>{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="perusahaan_id" name="perusahaan_id">
                            ...
                            <option value="{{ $perusahaan->id_perusahaan }}"
                                {{ $perusahaan->id_perusahaan == $data_usulan_pkl->perusahaan_id ? 'selected' : '' }}>
