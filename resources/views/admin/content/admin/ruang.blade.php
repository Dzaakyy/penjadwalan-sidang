...
@section('admin')
    <div class="card shadow-sm">
        ...
        @endif
            ...
            <a href="{{ route('ruang.create') }}" class="btn btn-primary me-2 mb-3">
                    ...
                    <tbody>
                        @foreach ($data_ruang as $data)
                            <tr class="table-Light">
                                ...
                                <td style="width: 10%;">
                                    <div class="d-flex">
                                        <a href="{{ route('ruang.edit', ['id' => $data->id_ruang]) }}"
                                            class="btn btn-primary mb-2 me-2 align-items-center"><span
                                                class="bi bi-pencil-square"></span>Edit</a>

                                        <a data-bs-toggle="modal" data-bs-target="#staticBackdrop{{ $data->id_ruang }}"
                            ...
                            <div class="modal fade" id="staticBackdrop{{ $data->id_ruang }}" data-bs-backdrop="static"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <form action="{{ route('ruang.delete', ['id' => $data->id_ruang]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
