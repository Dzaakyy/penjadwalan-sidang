...
@section('admin')
    <div class="card shadow-sm">
        ...
        @endif
            ...
            <a href="{{ route('jurusan.create') }}" class="btn btn-primary me-2 mb-3">
                <i class="bi bi-file-earmark-plus"></i> New
            </a>
            <a href="{{ route('jurusan.export') }}" class="btn btn-primary me-2 mb-3">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('jurusan.import') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                    ...
                    <tbody>
                        @foreach ($data_jurusan as $data)
                            <tr class="table-Light">
                                ...
                                <td style="width: 10%;">
                                    <div class="d-flex">
                                        <a href="{{ route('jurusan.edit', ['id' => $data->id_jurusan]) }}"
                                            class="btn btn-primary mb-2 me-2 align-items-center"><span
                                                class="bi bi-pencil-square"></span>Edit</a>

                                        <a data-bs-toggle="modal" data-bs-target="#staticBackdrop{{ $data->id_jurusan }}"
                            ...
                            <div class="modal fade" id="staticBackdrop{{ $data->id_jurusan }}" data-bs-backdrop="static"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Apakah kamu yakin ingin menghapus data
                                                <b>{{ $data->nama_jurusan }}</b>
                                            </p>
                                        </div>
                                        <div class="modal-footer justify-content-between">

                                            <form action="{{ route('jurusan.delete', ['id' => $data->id_jurusan]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
