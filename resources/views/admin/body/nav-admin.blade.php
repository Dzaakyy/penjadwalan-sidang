            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown"
                    ...
                    @if (Auth::user()->r_dosen && Auth::user()->r_dosen->image)
                        <img class="img-xs rounded-circle"
                            src="{{ asset('storage/uploads/dosen/image/' . Auth::user()->r_dosen->image) }}"
                            alt="Profile image">
                    @elseif (Auth::user()->r_mahasiswa && Auth::user()->r_mahasiswa->image)
                        <img class="img-xs rounded-circle"
                            src="{{ asset('storage/uploads/mahasiswa/image/' . Auth::user()->r_mahasiswa->image) }}"
                            alt="Profile image">
                    @else
                        <img class="img-xs rounded-circle" src="{{ asset('admin/assets/images/faces/default.png') }}"
                            alt="Profile image">
                    @endif
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                        ...
                        @else
                            <img class="img-xs rounded-circle"
                                src="{{ asset('admin/assets/images/faces/default.png') }}" alt="Profile image">
                        @endif
