        ...
        try {
            ...
            foreach ($rows as $row) {
                ...
                if (!$data_user) {
                    ...
                    $data_user->assignRole('dosen');
                    Log::info('Assigned "dosen" role to user: ' . $email);
                }
                ...
                $golonganValue = $row['golongan'] ?? null;


                if (!in_array($golonganValue, ['0', '1', '2', '3'])) {
                    $golonganValue = '3';
                    Log::warning('Invalid golongan value, using default: ' . $golonganValue);
                }
